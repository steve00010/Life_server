...
EPOCH_server_buildItem = compileFinal preprocessFileLineNumbers "\x\addons\a3_epoch_server\compile\epoch_bases\EPOCH_server_buildItem.sqf";
...
EPOCH_server_substr = compileFinal preprocessFileLineNumbers "\x\addons\a3_epoch_server\compile\epoch_hive\EPOCH_server_substr.sqf";
