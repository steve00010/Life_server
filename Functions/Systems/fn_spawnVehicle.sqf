...
{
	serv_sv_use = serv_sv_use - [_vid];
	[[_price,{pbh_life_atmcash = pbh_life_atmcash + _this;}],"BIS_fnc_spawn",_unit,false] spawn life_fnc_MP;
...
if((_vInfo select 1) == "cop" && (_vInfo select 2) in ["C_Offroad_01_F","B_MRAP_01_F","C_SUV_01_F","C_Hatchback_01_sport_F","C_Hatchback_01_F","I_MRAP_03_F"]) then
{
