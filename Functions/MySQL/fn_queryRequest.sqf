...
_query = switch(_side) do {
	...
	case east: {_returnCount = 9; format["SELECT playerid, name, cash, bankacc, adminlevel, donatorlvl, arc_licenses, arclevel, arc_gear FROM players WHERE playerid='%1'",_uid];};	
};
