...
_query = format["INSERT INTO players (playerid, name, cash, bankacc, aliases, cop_licenses, med_licenses, arc_licenses, civ_licenses, civ_gear, cop_gear, med_gear, arc_gear, drugaddiction, arc_gear) VALUES('%1', '%2', '%3', '%4', '%5','""[]""','""[]""','""[]""','""[]""','""[]""','""[]""','""[0,0,0]""','""[0,0,0]""')",
	_uid,
	_name,
	_money,
	_bank,
